...
func Connect() *sql.DB {
	...
	db.Exec("CREATE TABLE IF NOT EXISTS comments (id SERIAL PRIMARY KEY, created_at BIGINT NOT NULL, updated_at BIGINT NOT NULL, contents VARCHAR(240) NOT NULL, user_id INTEGER NOT NULL, post_id INTEGER NOT NULL);")
	return db
}
